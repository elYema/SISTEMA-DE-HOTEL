...
public class Registro extends javax.swing.JFrame {
 ...
 try {
        ...
        if (nombre.isEmpty() || telefono.isEmpty() || correo.isEmpty() || direccion.isEmpty() ||
            ...
            if (r.getDireccion().equalsIgnoreCase(direccion)) {
                throw new IllegalArgumentException("el id ingresada ya está registrada en otra reserva.");
            }
        }
    ...
    private void btninicioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btninicioActionPerformed
        SeleccionHabitacion vIn= new SeleccionHabitacion();
        vIn.setVisible(true);
        dispose();
